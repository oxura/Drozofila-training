...
Развёрнутый план после этапа 6 — [ROADMAP_BROAD_INTELLIGENCE.md](ROADMAP_BROAD_INTELLIGENCE.md).
Ближайший приоритет — новый опыт адресации и памяти; рост узлов и перестройка
связей проверяются отдельно. Это исследовательские предложения, ещё не
замороженный протокол этапа 7 и не результаты нового обучения.
